				...
				<div class="card">
				  <div class="card-header">
					...
					<div class="card-title pull-right">
							<a href="{{route('instansif.create')}}">Tambah Data</a>
						</div>
				  </div>
				  <!-- /.card-header -->
				  <div class="card-body">
					...
					<tr role="row" class="odd">
						...
						<td>
							{{-- <a href="{{ route('instansif.edit', $data->id) }}" class="btn btn-warning">Edit</a> --}}
						</td>
						<td>
							{{-- <a href="{{ route('instansif.show', $data->id) }}" class="btn btn-success">Show</a> --}}
						</td>
						<td>
							{{-- <form action="{{ route('instansif.destroy', $data->id) }}" method="post">
